...
public class TaskControllerTest {
    ...
    public void shouldFetchTasksList() throws Exception {
        ...
        when(taskMapper.mapToTaskDtoList(Matchers.anyList())).thenReturn(taskDtoList);
    ...
    public void shouldFetchTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(get("/v1/getTask")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .param("taskId", "1"))
                .andExpect(status().is(200))
    ...
    public void shouldDeleteTaskWhichDoesNotExist() throws Exception {
        ...
        //When & Then
        mockMvc.perform(delete("/v1/deleteTask/1")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .param("taskId", "1"))
    ...
    public void shouldDeleteTask() throws Exception {
        ...
        //When & Then
        mockMvc.perform(delete("/v1/deleteTask")
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF-8")
                .param("taskId", "1"))
                .andExpect(status().is(200));
